    ...
    <div class="p-4">
        ...
        <nav>
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{route('admin.members')}}" class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.members') ? 'bg-red-500 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
                ...
                <li>
                    <a href="{{route('reservations.show')}}" class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->routeIs('reservations.*') ? 'bg-red-500 text-white' : 'text-gray-300 hover:bg-gray-800' }}">
