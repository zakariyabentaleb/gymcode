...
<div class="max-w-3xl mx-auto mb-4">
    <div class="bg-white shadow-xl rounded-2xl p-8">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Modifier mon profil</h2>
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="bg-gray-200 hover:bg-gray-300 text-gray-800 transition duration-300 py-2 px-6 rounded-lg font-semibold">
                    Déconnexion
                </button>
            </form>
        </div>
